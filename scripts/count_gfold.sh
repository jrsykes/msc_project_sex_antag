...
tail -n +2 /data/projects/lross_ssa/analyses/$SPECIES/trinity/Trinity1k.fasta.transdecoder.bed | awk '{print $1,$2,$3,$4,$5,$6}' | sed 's/ /	/g' > /data/projects/lross_ssa/analyses/$SPECIES/trinity/test.bed
