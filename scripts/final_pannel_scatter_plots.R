...
annotate("text", x = -7, y = 8, label = "r = 0.76", size=10) + annotate("text", x = -7.5, y = 7, label = "n = 6", size=10) + 
geom_abline(slope= 1, intercept= exp(-10))
...
annotate("text", x = -7, y = 8, label = "r = 0.46", size=10) + annotate("text", x = -7.5, y = 7, label = "n = 2", size=10) + 
geom_abline(slope= 1, intercept= exp(-10))
...
annotate("text", x = -7, y = 8, label = "r = 0.19", size=10) + annotate("text", x = -7.5, y = 7, label = "n = 2", size=10) + 
geom_abline(slope= 1, intercept= exp(-10))
