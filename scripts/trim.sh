...
then
java -jar /exports/software/trimmomatic/Trimmomatic-0.36/trimmomatic-0.36.jar PE -phred33 /data/projects/lross_ssa/raw/planococcus_ficus/female/PF_1_F/170602_K00166_0222_BHJW3HBBXX_1_TP-D7-012_TP-D5-006_1.fastq.gz /data/projects/lross_ssa/raw/planococcus_ficus/female/PF_1_F/170602_K00166_0222_BHJW3HBBXX_1_TP-D7-012_TP-D5-006_2.fastq.gz /data/projects/lross_ssa/analyses/$species/trimmomatic/$sex/$SRR\_1.fq /data/projects/lross_ssa/analyses/$species/trimmomatic/$sex/$SRR\_forward_unpaired.fq.gz /data/projects/lross_ssa/analyses/$species/trimmomatic/$sex/$SRR\_2.fq /data/projects/lross_ssa/analyses/$species/trimmomatic/$sex/$SRR\_reverse_unpaired.fq.gz ILLUMINACLIP:/exports/software/trimmomatic/Trimmomatic-0.36/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36 HEADCROP:12 && /exports/software/fastqc/fastqc_v0.11.5/FastQC/fastqc --outdir /data/projects/lross_ssa/analyses/$species/fastqc2 /data/projects/lross_ssa/analyses/$species/trimmomatic/$sex/$SRR\_1.fq /data/projects/lross_ssa/analyses/$species/trimmomatic/$sex/$SRR\_2.fq && rm -f /data/projects/lross_ssa/raw/$species/$sex/$SRR\_1.fastq && rm -f /data/projects/lross_ssa/raw/$species/$sex/$SRR\_2.fastq
