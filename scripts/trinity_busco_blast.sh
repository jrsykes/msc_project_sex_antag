...
/data/projects/lross_ssa/scripts/faFilter -minSize=1000 /data/projects/lross_ssa/analyses/$species/trinity/Trinity.fasta /data/projects/lross_ssa/analyses/$species/trinity/Trinity1k.fasta && module load blast ; PATH=$PATH:/exports/software/hmmer/hmmer-3.1b1/bin/ ; python /exports/software/busco/busco-v2.0.1/BUSCO.py -f -i /data/projects/lross_ssa/analyses/$species/trinity/Trinity1k.fasta -o busco_$species -l /exports/software/busco/arthropoda -m tran -c 16 -sp fly && mkdir /data/projects/lross_ssa/analyses/$species/busco/busco_summaries && cp /data/projects/lross_ssa/analyses/$species/busco/run_busco_$species/short_summary_busco_$species.txt /data/projects/lross_ssa/analyses/$species/busco/busco_summaries && python /exports/software/busco/busco-v2.0.1/BUSCO_plot.py -wd /data/projects/lross_ssa/analyses/$species/busco/busco_summaries && mv /data/projects/lross_ssa/analyses/$species/busco/busco_summaries/busco_figure.png /data/projects/lross_ssa/analyses/$species/busco/busco_summaries/busco_$species.png
